  ...
  return (
    <div className="space-y-3 flex flex-col">
      ...
      <div>
        ...
        <TextInput.Root>
          <TextInput.Input type="date" value={rideData.date} onChange={e =>
            setRideData((d: any) => ({ ...d, date: e.target.value }))} placeholder="mm/dd/yyyy" />
        </TextInput.Root>
      ...
      <div>
        ...
        <TextInput.Root>
          <TextInput.Input type="number" value={rideData.passengers} onChange={e =>
            setRideData((d: any) => ({ ...d, passengers: e.target.value ? Number(e.target.value) : '' }))} placeholder="0" />
        </TextInput.Root>
        <FieldError id="passengers" errors={errors}/>
      </div>
      <div>
        <label className="text-gray-700 font-bold">Apenas ida ou volta:</label>
        <TextInput.Root>
          <TextInput.Input type="number" value={rideData.passengersOneWay} onChange={e =>
            setRideData((d: any) => ({ ...d, passengersOneWay: e.target.value ? Number(e.target.value) : '' }))} placeholder="0" />
        </TextInput.Root>
        <FieldError id="passengersOneWay" errors={errors}/>
      </div>
      <div>
        <label className="text-gray-700 font-bold">Preço por passageiro:</label>
        <TextInput.Root>
          <TextInput.Icon>
            <AiOutlineDollar />
          </TextInput.Icon>
      ...
      <div>
        ...
        <TextInput.Root>
          <TextInput.Input value={rideData.observations} onChange={e =>
            setRideData((d: any) => ({ ...d, observations: e.target.value }))} placeholder="Digite alguma informação adicional..." />
        </TextInput.Root>
      ...
      <div>
        ...
        <Switch
          value={rideData.paid}
          onChange={(value) => setRideData((d: any) => ({ ...d, paid: !d.paid }))}
        />
