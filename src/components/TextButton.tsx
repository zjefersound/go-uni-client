...
export function TextButton({ type = 'primary', children, onClick, className, ...props }: Props) {
  return (
    <button
      className={clsx("flex items-center font-bold w-min transition disabled:opacity-75", {
